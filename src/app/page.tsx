...
export default function Home() {
  return (
    <>
      {/* Hero — full-bleed photo slot (striped brand placeholder until photography lands) */}
      <section className="relative stripes border-b-[1.5px] border-line">
        <div className="mx-auto max-w-6xl px-5 py-24 md:py-32 flex flex-col items-center text-center gap-6">
          <h1 className="font-script font-bold text-5xl md:text-6xl leading-[1.05] text-ink max-w-2xl">
            The Lake Is Calling and We&apos;ve Got the Table.
          </h1>
          <p className="font-display font-medium text-lg text-muted max-w-xl">
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-2">
            ...
            <Link
              href="/events"
              className="px-6 py-3 bg-white border-2 border-[#cfccc2] rounded-lg font-display font-medium hover:border-olive"
            >
              See Live Music ♪
            </Link>
          </div>
      ...
      <section className="border-b-[1.5px] border-line bg-white/50">
        <div className="mx-auto max-w-6xl px-5 py-12 text-center">
          ...
          <p className="text-muted max-w-xl mx-auto mb-6">
            Hand-tossed pies, wings five ways, smoked brisket, crab cakes and
            lake-day baskets — plus breakfast on weekend mornings.
          </p>
          <div className="flex flex-wrap justify-center gap-3 mb-7 font-display font-medium text-sm">
        ...
        <div className="mx-auto max-w-6xl px-5 py-12 text-center">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-3xl mx-auto">
            {[0, 1, 2, 3].map((i) => (
              <div
                key={i}
                className="stripes h-28 rounded-lg border-[1.5px] border-dashed border-[#cfccc2]"
              />
            ))}
          </div>
          <a
